...
class Stager:
    def __init__(self, mainMenu):
        ...
        xmlVar = "".join(
            random.sample(
                string.ascii_uppercase + string.ascii_lowercase, random.randint(5, 9)
            )
        )
    ...
    def generate(self):
        ...
        shell_var = "".join(
            random.sample(
                string.ascii_uppercase + string.ascii_lowercase, random.randint(6, 9)
            )
        )
        lnk_var = "".join(
            random.sample(
