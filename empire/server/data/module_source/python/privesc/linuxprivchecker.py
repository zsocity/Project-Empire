...
def execute_cmd(cmddict):
    ...
    for item in cmddict:
        ...
        if compatmode == 0:  # newer version of python, use preferred subprocess
            out, error = sub.Popen(
                [cmd], stdout=sub.PIPE, stderr=sub.PIPE, shell=True
            ).communicate()
...
def enum_rc_files():
    ...
    rcfiles = {
        "GBASHRC": {
            "cmd": "cat /etc/bashrc 2>/dev/null",
            "msg": " Get the contents of bash rc file form global config file",
            "results": [],
        },
        "BASHRC": {
            "cmd": "cat ~/.bashrc 2>/dev/null",
            "msg": "Get the contents of bash rc file for current user",
            "results": [],
        },
        "SCREENRC": {
            "cmd": "cat ~/.screenrc 2>/dev/null",
            "msg": " Try to get the contents of screen rc file for current user",
            "results": [],
        },
        "GSCREENRC": {
            "cmd": "cat /etc/screenrc 2>/dev/null",
            "msg": "Try to get the contents of screen rc file form global config file",
            "results": [],
        },
        "VIRC": {
            "cmd": "cat ~/.virc 2>/dev/null",
            "msg": " Try to get the contents of vi rc file for current user",
            "results": [],
        },
        "MYSQLRC": {
            "cmd": "cat ~/.mysqlrc 2>/dev/null",
            "msg": " Try to get the contents of mysql rc file for current user",
            "results": [],
        },
        "NETRC": {
            "cmd": "cat ~/.netrc 2>/dev/null",
            "msg": " Try to get the contents of legacy net rc file for current user",
            "results": [],
        },
    }
...
def enum_procs_pkgs(sysinfo):
    ...
    pkgsandprocs = {
        "PROCS": {
            "cmd": "ps waux | awk '{print $1,$2,$9,$10,$11}'",
    ...
    otherapps = {
        ...
        "SSHAGENTS": {
            ...
            "msg": "Checking for Active SSH Agents",
            "results": [],
        },
    }
...
def find_likely_exploits(sysinfo, devtools, pkgsandprocs, driveinfo):
    ...
    sploits = {
        "2.2.x-2.4.x ptrace kmod local exploit": {
            "minver": "2.2",
            "maxver": "2.4.99",
            "exploitdb": "3",
            "lang": "c",
        ...
        "< 2.4.20 Module Loader Local Root Exploit": {
            "minver": "0",
            "maxver": "2.4.20",
            "exploitdb": "12",
            "lang": "c",
        ...
        "<= 2.4.22 (do_brk) Local Root Exploit (working)": {
            "minver": "0",
            "maxver": "2.4.22",
            "exploitdb": "131",
            "lang": "c",
        ...
        "2.4.x mremap() bound checking Root Exploit": {
            "minver": "2.4",
            "maxver": "2.4.99",
            "exploitdb": "145",
            "lang": "c",
        ...
        "<= 2.4.29-rc2 uselib() Privilege Elevation": {
            "minver": "0",
            "maxver": "2.4.29",
            "exploitdb": "744",
            "lang": "c",
        ...
        "2.4 uselib() Privilege Elevation Exploit": {
            "minver": "2.4",
            "maxver": "2.4",
            "exploitdb": "778",
            "lang": "c",
        ...
        "2.4.x / 2.6.x uselib() Local Privilege Escalation Exploit": {
            "minver": "2.4",
            "maxver": "2.6.99",
            "exploitdb": "895",
            "lang": "c",
        ...
        "2.4/2.6 bluez Local Root Privilege Escalation Exploit (update)": {
            "minver": "2.4",
            "maxver": "2.6.99",
            "exploitdb": "926",
            "lang": "c",
            "keywords": {"loc": ["proc", "pkg"], "val": "bluez"},
        },
        "<= 2.6.11 (CPL 0) Local Root Exploit (k-rad3.c)": {
            "minver": "0",
            "maxver": "2.6.11",
            "exploitdb": "1397",
            "lang": "c",
        ...
        "MySQL 4.x/5.0 User-Defined Function Local Privilege Escalation Exploit": {
            ...
            "exploitdb": "1518",
            "lang": "c",
            "keywords": {"loc": ["proc", "pkg"], "val": "mysql"},
        },
        "2.6.13 <= 2.6.17.4 sys_prctl() Local Root Exploit": {
            "minver": "2.6.13",
            "maxver": "2.6.17.4",
            "exploitdb": "2004",
            "lang": "c",
        ...
        "2.6.13 <= 2.6.17.4 sys_prctl() Local Root Exploit (2)": {
            "minver": "2.6.13",
            "maxver": "2.6.17.4",
            "exploitdb": "2005",
            "lang": "c",
        ...
        "2.6.13 <= 2.6.17.4 sys_prctl() Local Root Exploit (3)": {
            "minver": "2.6.13",
            "maxver": "2.6.17.4",
            "exploitdb": "2006",
            "lang": "c",
        ...
        "2.6.13 <= 2.6.17.4 sys_prctl() Local Root Exploit (4)": {
            "minver": "2.6.13",
            "maxver": "2.6.17.4",
            "exploitdb": "2011",
            "lang": "sh",
        ...
        "<= 2.6.17.4 (proc) Local Root Exploit": {
            "minver": "0",
            "maxver": "2.6.17.4",
            "exploitdb": "2013",
            "lang": "c",
        ...
        "2.6.13 <= 2.6.17.4 prctl() Local Root Exploit (logrotate)": {
            "minver": "2.6.13",
            "maxver": "2.6.17.4",
            "exploitdb": "2031",
            "lang": "c",
        ...
        "< 2.6.11.5 BLUETOOTH Stack Local Root Exploit": {
            "minver": "0",
            "maxver": "2.6.11.5",
            "exploitdb": "4756",
            "lang": "c",
        ...
        "2.6.17 - 2.6.24.1 vmsplice Local Root Exploit": {
            "minver": "2.6.17",
            "maxver": "2.6.24.1",
            "exploitdb": "5092",
            "lang": "c",
        ...
        "2.6.23 - 2.6.24 vmsplice Local Root Exploit": {
            "minver": "2.6.23",
            "maxver": "2.6.24",
            "exploitdb": "5093",
            "lang": "c",
        ...
        "< 2.6.29 exit_notify() Local Privilege Escalation Exploit": {
            "minver": "0",
            "maxver": "2.6.29",
            "exploitdb": "8369",
            "lang": "c",
        ...
        "2.6 UDEV Local Privilege Escalation Exploit": {
            "minver": "2.6",
            "maxver": "2.6.99",
            "exploitdb": "8478",
            "lang": "c",
        ...
        "2.6 UDEV < 141 Local Privilege Escalation Exploit": {
            "minver": "2.6",
            "maxver": "2.6.99",
            "exploitdb": "8572",
            "lang": "c",
        ...
        "2.6.x ptrace_attach Local Privilege Escalation Exploit": {
            "minver": "2.6",
            "maxver": "2.6.99",
            "exploitdb": "8673",
            "lang": "c",
        ...
        "2.6.29 ptrace_attach() Local Root Race Condition Exploit": {
            "minver": "2.6.29",
            "maxver": "2.6.29",
            "exploitdb": "8678",
            "lang": "c",
        ...
        "Test Kernel Local Root Exploit 0day": {
            "minver": "2.6.18",
            "maxver": "2.6.30",
            "exploitdb": "9191",
            "lang": "c",
        ...
        "PulseAudio (setuid) Priv. Escalation Exploit (ubu/9.04)(slack/12.2.0)": {
            ...
            "exploitdb": "9208",
            "lang": "c",
            "keywords": {"loc": ["pkg"], "val": "pulse"},
        },
        "2.x sock_sendpage() Local Ring0 Root Exploit": {
            "minver": "2",
            "maxver": "2.99",
            "exploitdb": "9435",
            "lang": "c",
        ...
        "2.x sock_sendpage() Local Root Exploit 2": {
            "minver": "2",
            "maxver": "2.99",
            "exploitdb": "9436",
            "lang": "c",
        ...
        "2.4/2.6 sock_sendpage() ring0 Root Exploit (simple ver)": {
            "minver": "2.4",
            "maxver": "2.6.99",
            "exploitdb": "9479",
            "lang": "c",
        ...
        "2.6 < 2.6.19 (32bit) ip_append_data() ring0 Root Exploit": {
            "minver": "2.6",
            "maxver": "2.6.19",
            "exploitdb": "9542",
            "lang": "c",
        ...
        "2.4/2.6 sock_sendpage() Local Root Exploit (ppc)": {
            "minver": "2.4",
            "maxver": "2.6.99",
            "exploitdb": "9545",
            "lang": "c",
        ...
        "< 2.6.19 udp_sendmsg Local Root Exploit (x86/x64)": {
            "minver": "0",
            "maxver": "2.6.19",
            "exploitdb": "9574",
            "lang": "c",
        ...
        "< 2.6.19 udp_sendmsg Local Root Exploit": {
            "minver": "0",
            "maxver": "2.6.19",
            "exploitdb": "9575",
            "lang": "c",
        ...
        "2.4/2.6 sock_sendpage() Local Root Exploit [2]": {
            "minver": "2.4",
            "maxver": "2.6.99",
            "exploitdb": "9598",
            "lang": "c",
        ...
        "2.4/2.6 sock_sendpage() Local Root Exploit [3]": {
            "minver": "2.4",
            "maxver": "2.6.99",
            "exploitdb": "9641",
            "lang": "c",
        ...
        "2.4.1-2.4.37 and 2.6.1-2.6.32-rc5 Pipe.c Privelege Escalation": {
            "minver": "2.4.1",
            "maxver": "2.6.32",
            "exploitdb": "9844",
            "lang": "python",
        ...
        "'pipe.c' Local Privilege Escalation Vulnerability": {
            "minver": "2.4.1",
            "maxver": "2.6.32",
            "exploitdb": "10018",
            "lang": "sh",
        ...
        "Apache Spamassassin Milter Plugin Remote Root Command Execution": {
            ...
            "exploitdb": "11662",
            "lang": "sh",
            "keywords": {"loc": ["proc"], "val": "spamass-milter"},
        },
        ...
        "< 2.6.36-rc1 CAN BCM Privilege Escalation Exploit": {
            "minver": "0",
            "maxver": "2.6.36",
            "exploitdb": "14814",
            "lang": "c",
        ...
        "< 2.6.37-rc2 ACPI custom_method Privilege Escalation": {
            "minver": "0",
            "maxver": "2.6.37",
            "exploitdb": "15774",
            "lang": "c",
        ...
        "< 2.6.36.2 Econet Privilege Escalation Exploit": {
            "minver": "0",
            "maxver": "2.6.36.2",
            "exploitdb": "17787",
            "lang": "c",
        ...
        "2.4.18/19 Privileged File Descriptor Resource Exhaustion Vulnerability": {
            "minver": "2.4.18",
            "maxver": "2.4.19",
            "exploitdb": "21598",
            "lang": "c",
        ...
        "2.2.x/2.4.x Privileged Process Hijacking Vulnerability (1)": {
            "minver": "2.2",
            "maxver": "2.4.99",
            "exploitdb": "22362",
            "lang": "c",
        ...
        "2.2.x/2.4.x Privileged Process Hijacking Vulnerability (2)": {
            "minver": "2.2",
            "maxver": "2.4.99",
            "exploitdb": "22363",
            "lang": "c",
        ...
        "Samba 2.2.8 Share Local Privilege Elevation Vulnerability": {
            "minver": "2.2.8",
            "maxver": "2.2.8",
            "exploitdb": "23674",
            "lang": "c",
            "keywords": {"loc": ["proc", "pkg"], "val": "samba"},
        },
    ...
    for sploit in sploits:
        ...
        if (version >= sploits[sploit]["minver"]) and (
            version <= sploits[sploit]["maxver"]
        ):
            # next check language applicability
            if (sploits[sploit]["lang"] == "c") and (
                ("gcc" in str(langs)) or ("cc" in str(langs))
            ):
            ...
            if lang == 0:
                sploitout = (
                    sploitout + "**"
                )  # added mark if language not detected on system
...
def run_check():
    ...
    try:
        ...
        parser = argparse.ArgumentParser(
            description="Try to gather system information and find likely exploits"
        )
        parser.add_argument(
            "-s",
            "--searches",
            help="Skip time consumming or resource intensive searches",
            required=False,
            action="store_true",
        )
        parser.add_argument(
            "-w",
            "--write",
            help="Wether to write a log file, can be used with -0 to specify name/location ",
            required=False,
            action="store_true",
        )
        parser.add_argument(
            "-o",
            "--outfile",
            help="The file to write results (needs to be writable for current user)",
            required=False,
            default="linuxprivchecker.log",
        )
